...
var pointerRender = document.getElementById('gallery');
var gallery = document.querySelector('.gallery');
sendForm.addEventListener('submit', function (event) {
  event.preventDefault();
  var searchNameImg = document.getElementById('searchNameImg').value;
  var url = "https://api.unsplash.com/search/photos?per_page=10&page=1&query=".concat(searchNameImg);
...
function openImgFull(src) {
  var divOpenFullImg = document.createElement('div');
  divOpenFullImg.className = 'fullImg';
  divOpenFullImg.addEventListener('click', function (e) {
    e.preventDefault();
